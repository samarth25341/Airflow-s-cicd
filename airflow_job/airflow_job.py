...
with DAG(
    ...
    gcs_bucket = Variable.get("gcs_bucket", default_var="sam-airflow-project-gds")
    bq_project = Variable.get("bq_project", default_var="dogwood-theorem-467417-b3")
    ...
    batch_details = {
        ...
        "environment_config": {
            "execution_config": {
                "service_account": "693115709814-compute@developer.gserviceaccount.com",
                "network_uri": "projects/dogwood-theorem-467417-b3/global/networks/default",
                "subnetwork_uri": "projects/dogwood-theorem-467417-b3/regions/asia-east1/subnetworks/default",
            }
        },
    }
